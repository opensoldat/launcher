...
import ClientLaunchSettingsStore, {
  ClientLaunchSettings,
} from "./clientLaunchSettings";
import ServerLaunchSettingsStore, {
  ServerLaunchSettings,
} from "./serverLaunchSettings";
  ...
  @action loadData(): void {
    ...
    window.launcher
      ...
      .then((launcherData) => {
        ...
        this.clientLaunchSettingsStore.setSettings(
          launcherData?.clientLaunchSettings
        );
        this.serverLaunchSettingsStore.setSettings(
          launcherData?.serverLaunchSettings
        );
      })
      .finally(
        action(() => {
