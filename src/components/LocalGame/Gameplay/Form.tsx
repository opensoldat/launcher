  ...
  return (
    <div className="gameplay-form form">
      ...
      {gameplay.styles.survivalEnabled && (
        <div className="field">
          <label className="label">Survival settings</label>
          <div className="user-input">
            <Checkbox
              colorTheme="dark"
        ...
        <React.Fragment>
          ...
          <div className="field">
            ...
            <Tooltip id="max-wave-respawn-time-tooltip">
              <div>
                A global respawn timer is used so everyone that dies waits until
                this timer ends,
              </div>
      ...
      <div className="field">
        ...
        <Tooltip id="respawn-time-tooltip">
          <div>
            Time that it takes for the player to respawn after death in non-team
            game modes.
          </div>
          <div>
            Additionally, it affects the behavior of some game objects, like
            medikits.
          </div>
        </Tooltip>
      </div>
      ...
      <div className="field">
        ...
        <Tooltip id="bullet-time-tooltip">
          A slow motion bullet time effect appears when all players are near
          death.
        </Tooltip>
      </div>
