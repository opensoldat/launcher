...
const AdvancedForm: React.FC<AdvancedFormProps> = (props) => {
  ...
  return (
    <div className="form">
        ...
        <div className="user-input">
          ...
          <div className="error-message">
            {props.networkSettings.portError &&
              props.networkSettings.portError.length > 0 &&
              props.networkSettings.portError}
          </div>
        </div>
      </div>
      ...
      <div className="field">
        <label className="label label-with-info" htmlFor="launch-arguments">
        ...
        <LaunchArgumentsTooltip id="launch-arguments-tooltip" target="server" />
      </div>
    </div>
  );
};
