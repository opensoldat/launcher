...
const MapsSelection: React.FC<MapsSelectionProps> = (props) => {
  ...
  const isLoadingAvailableMaps =
    props.mapsStore.isLoading || !props.mapsStore.gotMaps;
    ...
    <div className="map-selection-container">
      <div className="map-selection">
        <div className="maps-list-actions">
          ...
          <InlineRefreshButton onClick={handleRefreshMapsButtonClick} />
        </div>
        ...
        <div className="maps-list-container">
          ...
          >
            {props.mapsStore
              .filterMaps(props.uiState.searchFilter)
              .map((map: Map) => (
                <MapsListItem
                  key={map.id}
        ...
        <div className="maps-list-container">
          <div className="maps-list-header">
            <div>Selected:</div>
            <button className="button red-button" onClick={handleClearClick}>
              Clear
            </button>
          </div>

          <MapsList emptyMessage="Empty" isLoading={false}>
