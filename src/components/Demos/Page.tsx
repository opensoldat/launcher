...
const DemosPage: React.FC<DemosPageProps> = (props) => {
  ...
  const filteredDemosFileNames = props.demosStore.filterDemos(
    props.uiState.searchTerm
  );
   ...
   */
  if (
    props.uiState.selectedDemoFileName?.length &&
  ...
  return (
    <div className="demos-page">
      ...
      <div className="action-buttons">
        {props.uiState.selectedDemoFileName &&
          props.uiState.selectedDemoFileName.length > 0 && (
            <button
