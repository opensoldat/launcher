...
const ConnectForm: React.FC<ConnectFormProps> = props => {
    const handleDisconnectClick = (): void => {
        props.onlineGamesStore.disconnect(props.connectFormStore.ip, Number(props.connectFormStore.port));
    }
    ...
    return (
        <form
            ...
            <div className="field">
                ...
                {(props.connectFormStore.ipError && props.connectFormStore.ipError.length > 0) &&
            ...
            <div className="field">
                ...
                <div className="error-message">
                {(props.connectFormStore.portError && props.connectFormStore.portError.length > 0) &&
            ...
            <div className="field button-field">
                {
                    ...
                    props.onlineGamesStore.getClient(props.connectFormStore.ip, Number(props.connectFormStore.port)))
