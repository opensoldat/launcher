...
const GamePanel: React.FC<GamePanelProps> = (props) => {
  ...
  const handleCustomLaunchArgumentsChange = (
    ...
    <div className="settings-panel-container">
      <Panel>
        {isLoading ? (
          ...
          <div className="form">
            <div className="field">
              <label className="label" htmlFor="screen-shake">
            ...
            <div className="field">
              <label className="label" htmlFor="screenshot-after-round">
            ...
            <div className="field">
              <label className="label" htmlFor="server-mods">
                Allow server mods
              </label>
              <div className="user-input">
                <Checkbox
            ...
            <div className="fields-group">
              ...
              <div className="field">
                <label className="label label-with-info" htmlFor="local-mount">
                  Local mount
                  <FontAwesomeIcon
                    className="info-icon"
                    data-tip
                ...
                <div className="user-input">
                  {showModsSpinner ? (
                    ...
                    <div className="inline">
                      ...
                      />
                      <InlineRefreshButton
                        onClick={(): void => props.modsStore.loadMods()}
                      />
                    </div>
                  )}
                </div>
