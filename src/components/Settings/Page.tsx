  ...
  return (
    <div className="settings-page">
      ...
      >
        ...
        <TabPanel>
          <PlayerPanel
            playerSettingsStore={props.clientSettingsStore.playerSettingsStore}
          />
        </TabPanel>
        ...
        <TabPanel>
          <ControlsPanel
            controlsWrapperStore={
              props.clientSettingsStore.controlsWrapperStore
            }
          />
        </TabPanel>
        ...
        <TabPanel>
          <GraphicsPanel
            graphicsSettingsStore={
              props.clientSettingsStore.graphicsSettingsStore
            }
        ...
        <TabPanel>
          <SoundPanel
            soundSettingsStore={props.clientSettingsStore.soundSettingsStore}
          />
        </TabPanel>
      </Tabs>
    </div>
