...
const GraphicsPanel: React.FC<GraphicsPanelProps> = (props) => {
  if (
    !props.graphicsSettingsStore.isLoading &&
    !props.graphicsSettingsStore.settings
  ) {
    props.graphicsSettingsStore.loadSettings();
  }

  if (
    !props.interfacesStore.isLoading &&
  ...
  const showInterfacesSpinner =
    props.interfacesStore.isLoading || !props.interfacesStore.gotInterfaces;
    ...
    <div className="settings-panel-container">
      <Panel>
        {isLoading ? (
          ...
          <div className="form">
            <div className="field">
              <label className="label" htmlFor="display-mode">
                Display mode
              </label>
              <div className="user-input">
                <Select
                  options={[
                    ...
                    {
                      value: DisplayModes.FullscreenWindow.toString(),
                      label: "Fullscreen window",
                    },
                    {
                      value: DisplayModes.Fullscreen.toString(),
                      label: "Fullscreen",
                    },
                  ]}
            ...
            <div className="fields-group">
              ...
              <div className="field">
                <label className="label" htmlFor="weather-effects">
              ...
              <div className="field">
                <label className="label" htmlFor="smooth-edges">
              ...
              <div className="field">
                <label className="label" htmlFor="background-sceneries">
              ...
              <div className="field">
                <label className="label" htmlFor="force-background-color">
              ...
              {graphicsSettings.forceBackground && (
                <React.Fragment>
                  <div className="field">
                    <label className="label" htmlFor="background-top-color">
                  ...
                  <div className="field">
                    <label className="label" htmlFor="background-bottom-color">
              ...
              <div className="field">
                <label className="label" htmlFor="limit-fps">
              ...
              {graphicsSettings.limitFPS && (
                <div className="field">
                  <label className="label" htmlFor="max-fps">
            ...
            <div className="fields-group">
              ...
              <div className="field">
                <label className="label" htmlFor="scale-interface">
                  Scale interface
                </label>
                <div className="user-input">
                  <Checkbox
              ...
              <div className="field">
                <label className="label" htmlFor="player-indicator">
              ...
              <div className="field">
                <label className="label" htmlFor="kills-list">
                  Display kills list
                </label>
                <div className="user-input">
                  <Checkbox
            ...
            <div className="fields-group">
              ...
              <div className="field">
                <label className="label" htmlFor="vertical-sync">
                  Vertical sync
                </label>
                <div className="user-input">
                  <Checkbox
              ...
              <div className="field">
                <label className="label" htmlFor="dithering">
                  Dithering
                </label>
                <div className="user-input">
                  <Checkbox
